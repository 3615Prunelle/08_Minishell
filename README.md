...
> * echo No one has ever seen $USER and $HERO in the same room
> * env | grep MAIL
> * wc -l < sources/main.c
> * grep potato << end
> * cd ../..
...
> * sort < BadassFile
> * ls -la | grep o | wc -l
> * cat BadassFile | sort | tail -5
> * pwd | grep e | wc -m
> * echo Courgette | cat -e > Another_BadassFile
> * cat BadassFile Another_BadassFile > There

Useful tips :
> * Ctrl-C displays a new line with a new prompt
> * Ctrl-D quits minishell
